...
<body>
  	<div style="margin:5px; padding:0px; background:#333; color:#fff">
		<h1 style="margin:0px; background:#482D68; color:#fff; padding:10px 20px; text-align:center">
		Contact form</h1>
		<p>&nbsp;A user has submitted the below email for Contact form</p>
		...
		<tr>
		<td style="background:#444; border:1px solid #333; padding:5px">Subject</td>
