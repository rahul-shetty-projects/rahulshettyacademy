...
<html lang="en">
<head>
  <title>Consulting Subscription</title>
</head>
<body>
  	<div style="margin:5px; padding:0px; background:#333; color:#fff">
		<h1 style="margin:0px; background:#2D6843; color:#fff; padding:10px 20px; text-align:center">
		Consulting Subscription</h1>
		<p>&nbsp;A user has submitted the below email for consulting subscription</p>
		...
		<tr>
		<td style="background:#444; border:1px solid #333; padding:5px">Timezone</td>
		<td style="background:#444; border:1px solid #333; padding:5px">{{ $data->timezone }}</td>
		</tr>
		<tr>
		<td style="background:#444; border:1px solid #333; padding:5px">City</td>
		<td style="background:#444; border:1px solid #333; padding:5px">{{ $data->city }}</td>
		</tr>
		<tr>
		<td style="background:#444; border:1px solid #333; padding:5px">Description</td>
		<td style="background:#444; border:1px solid #333; padding:5px">{{ $data->description }}</td>
		</tr>
		<tr>
		<td style="background:#444; border:1px solid #333; padding:5px">Service Type</td>
		<td style="background:#444; border:1px solid #333; padding:5px">%stype%</td>
		</tr>
		</tbody>
		</table>
		<br>
