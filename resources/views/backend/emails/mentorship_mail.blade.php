...
<html lang="en">
<head>
  <title>Mentorship Subscription</title>
</head>
<body>
  	<div style="margin:5px; padding:0px; background:#333; color:#fff">
		<h1 style="margin:0px; background:#2d3a68; color:#fff; padding:10px 20px; text-align:center">
		Mentorship Subscription</h1>
		<p>&nbsp;A user has submitted the below email for mentorship subscription</p>
		...
		<tr>
		<td style="background:#444; border:1px solid #333; padding:5px">Bio</td>
		<td style="background:#444; border:1px solid #333; padding:5px">{{ $data->bio }}</td>
		</tr>
		<tr>
		<td style="background:#444; border:1px solid #333; padding:5px">Service Type</td>
		<td style="background:#444; border:1px solid #333; padding:5px">{{ $data->stype }}</td>
		</tr>
		</tbody>
		</table>
		<br>
